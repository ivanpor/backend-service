...
@Import({ BinderFactoryConfiguration.class, ChannelBindingAutoConfiguration.class, BindingServiceConfiguration.class })
public class SpringCloudStreamConfiguration {
	 ...
	 */
//	@Bean
//	public MessageConverterConfigurer messageConverterConfigurer(BindingService bindingService,CompositeMessageConverterFactory compositeMessageConverterFactory) {
//		return new MessageConverterConfigurer(bindingService.getBindingServiceProperties(), compositeMessageConverterFactory);
//	}
}